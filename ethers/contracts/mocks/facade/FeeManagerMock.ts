...
export interface FeeManagerMockInterface extends utils.Interface {
  functions: {
    "__FeeManagerMock_init(address)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "__FeeManagerMock_init"
      | "__FeeManagerMock_init(address)"
      | "__FeeManager_init"
  ...
  encodeFunctionData(
    functionFragment: "__FeeManagerMock_init",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "__FeeManagerMock_init(address)",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface FeeManagerMock extends BaseContract {
  contractName: "FeeManagerMock";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FeeManagerMockInterface;
