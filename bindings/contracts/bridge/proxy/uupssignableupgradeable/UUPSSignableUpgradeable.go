...
package uupssignableupgradeable
...
// UUPSSignableUpgradeableInitializedIterator is returned from FilterInitialized and is used to iterate over the raw logs and unpacked data for Initialized events raised by the UUPSSignableUpgradeable contract.
type UUPSSignableUpgradeableInitializedIterator struct {
	Event *UUPSSignableUpgradeableInitialized // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *UUPSSignableUpgradeableInitializedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(UUPSSignableUpgradeableInitialized)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *UUPSSignableUpgradeableInitializedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *UUPSSignableUpgradeableInitializedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// UUPSSignableUpgradeableInitialized represents a Initialized event raised by the UUPSSignableUpgradeable contract.
type UUPSSignableUpgradeableInitialized struct {
	Version uint8
	Raw     types.Log // Blockchain specific contextual infos
}
...
func (_UUPSSignableUpgradeable *UUPSSignableUpgradeableFilterer) FilterInitialized(opts *bind.FilterOpts) (*UUPSSignableUpgradeableInitializedIterator, error) {

	logs, sub, err := _UUPSSignableUpgradeable.contract.FilterLogs(opts, "Initialized")
	if err != nil {
		return nil, err
	}
	return &UUPSSignableUpgradeableInitializedIterator{contract: _UUPSSignableUpgradeable.contract, event: "Initialized", logs: logs, sub: sub}, nil
}

// WatchInitialized is a free log subscription operation binding the contract event 0x7f26b83ff96e1f2b6a682f133852f6798a09c465da95921460cefb3847402498.
//
// Solidity: event Initialized(uint8 version)
func (_UUPSSignableUpgradeable *UUPSSignableUpgradeableFilterer) WatchInitialized(opts *bind.WatchOpts, sink chan<- *UUPSSignableUpgradeableInitialized) (event.Subscription, error) {

	logs, sub, err := _UUPSSignableUpgradeable.contract.WatchLogs(opts, "Initialized")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(UUPSSignableUpgradeableInitialized)
				if err := _UUPSSignableUpgradeable.contract.UnpackLog(event, "Initialized", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Initialized(uint8 version)
func (_UUPSSignableUpgradeable *UUPSSignableUpgradeableFilterer) ParseInitialized(log types.Log) (*UUPSSignableUpgradeableInitialized, error) {
	event := new(UUPSSignableUpgradeableInitialized)
	if err := _UUPSSignableUpgradeable.contract.UnpackLog(event, "Initialized", log); err != nil {
		return nil, err
	}
