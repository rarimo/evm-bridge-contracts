...
func (_Bridge *BridgeTransactor) BundlerInit(opts *bind.TransactOpts, bundleExecutorImplementation_ common.Address) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "__Bundler_init", bundleExecutorImplementation_)
}

// BundlerInit is a paid mutator transaction binding the contract method 0x654d62aa.
//
// Solidity: function __Bundler_init(address bundleExecutorImplementation_) returns()
func (_Bridge *BridgeSession) BundlerInit(bundleExecutorImplementation_ common.Address) (*types.Transaction, error) {
	return _Bridge.Contract.BundlerInit(&_Bridge.TransactOpts, bundleExecutorImplementation_)
}

// BundlerInit is a paid mutator transaction binding the contract method 0x654d62aa.
//
// Solidity: function __Bundler_init(address bundleExecutorImplementation_) returns()
func (_Bridge *BridgeTransactorSession) BundlerInit(bundleExecutorImplementation_ common.Address) (*types.Transaction, error) {
	return _Bridge.Contract.BundlerInit(&_Bridge.TransactOpts, bundleExecutorImplementation_)
}
...
func (_Bridge *BridgeTransactor) SignersInit(opts *bind.TransactOpts, signer_ common.Address, facade_ common.Address, chainName_ string) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "__Signers_init", signer_, facade_, chainName_)
}

// SignersInit is a paid mutator transaction binding the contract method 0x3baa7892.
//
// Solidity: function __Signers_init(address signer_, address facade_, string chainName_) returns()
func (_Bridge *BridgeSession) SignersInit(signer_ common.Address, facade_ common.Address, chainName_ string) (*types.Transaction, error) {
	return _Bridge.Contract.SignersInit(&_Bridge.TransactOpts, signer_, facade_, chainName_)
}

// SignersInit is a paid mutator transaction binding the contract method 0x3baa7892.
//
// Solidity: function __Signers_init(address signer_, address facade_, string chainName_) returns()
func (_Bridge *BridgeTransactorSession) SignersInit(signer_ common.Address, facade_ common.Address, chainName_ string) (*types.Transaction, error) {
	return _Bridge.Contract.SignersInit(&_Bridge.TransactOpts, signer_, facade_, chainName_)
}
